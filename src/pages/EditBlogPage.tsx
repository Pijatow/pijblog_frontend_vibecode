...
import type { BlogStatus, BlogEntry } from '../types';
...
export function EditBlogPage() {
  ...
  useEffect(() => {
    const loadBlog = async () => {
      ...
      try {
        ...
        setErrors({
          general: 'Failed to load blog post',
        });
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const updatedBlog = await blogService.updateBySlug(slug, {
      ...
      setErrors({
        general: err.response?.data?.detail || 'Failed to update blog post',
      });
    } finally {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="text-4xl font-bold text-primary dark:text-gray-100 mb-8">Edit Post</h1>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <Card>
              <h3 className="font-semibold text-primary mb-4">Update</h3>
